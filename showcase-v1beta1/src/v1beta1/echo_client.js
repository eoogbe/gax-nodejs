...
const showcaseGrpcModule = require('../google/showcase/v1beta1/echo_grpc_web_pb');
...
class EchoClient {
  ...
  constructor(opts) {
    ...
    protoFilesRoot = protobuf.loadSync(
      path.join(__dirname, '..', '..', 'protos', 'google/showcase/v1beta1/echo.proto'),
      protoFilesRoot
    );
